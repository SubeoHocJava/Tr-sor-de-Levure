...
namespace Web_WineShop.Models.CheckoutModel
{
	public class CheckoutModel
	{
		...
		{
			return $"UserId: {UserId}, Name: {Name}, Phone: {Phone}, Email: {Email}, Address: {Address}, " +
				   $"PaymentMethodId: {PaymentMethodId}, SubTotal: {SubTotal()}, Discount: {Discount()}, TotalAmount: {TotalAmount()}";
		}
